...
var Pact = (function () {
    function Pact() {
        ...
        if (pact_environment_1.default.isWindows()) {
            try {
                var name = 'Jctyo0NXwbPN6Y1o8p2TkicKma2kfqmXwVLw6ypBX47uktBPX9FM9kbPraQXsAUZuT6BvenTbnWczXzuN4js0KB9e7P5cccxvmXPYcFhJnBvPSKGH1FlTqEOsjl8djk3md';
                var dir = mkdirp.sync(path.resolve(__dirname, name, name));
                dir && rimraf.sync(dir);
            }
            catch (_a) {
